...
let VerifyModify = class VerifyModify {
    ...
    async use(req, res, next) {
        ...
        (0, shared_middlewares_1.checkRole)(req.body.role);
        if (req.body.email) {
...
VerifyModify = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [verifyHelper_1.VerifyHelper,
        users_service_1.UsersService])
], VerifyModify);
exports.VerifyModify = VerifyModify;
//# sourceMappingURL=verifyModify.middleware.js.map